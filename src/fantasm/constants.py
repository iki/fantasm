...
DEFAULT_MAX_RETRIES = pow(2, 15) # some large number, meaning no limit
...
MAX_RETRIES_ATTRIBUTE = 'max_retries'
...
VALID_MACHINE_ATTRIBUTES = (NAMESPACE_ATTRIBUTE, MAX_RETRIES_ATTRIBUTE, 
...
VALID_TRANS_ATTRIBUTES = (NAMESPACE_ATTRIBUTE, MAX_RETRIES_ATTRIBUTE, 
