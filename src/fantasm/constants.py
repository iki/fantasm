...
DEFAULT_TASK_RETRY_LIMIT = pow(2, 15) # some large number meaning no limit
DEFAULT_MIN_BACKOFF_SECONDS_ATTRIBUTE = -1  # -1 meaning not set
DEFAULT_MAX_BACKOFF_SECONDS_ATTRIBUTE = -1
DEFAULT_TASK_AGE_LIMIT_ATTRIBUTE = -1
DEFAULT_MAX_DOUBLINGS_ATTRIBUTE = -1
...
MACHINE_QUEUE_NAME_ATTRIBUTE = 'queue'
...
VALID_MACHINE_ATTRIBUTES = (NAMESPACE_ATTRIBUTE, MAX_RETRIES_ATTRIBUTE, TASK_RETRY_LIMIT_ATTRIBUTE,
                            ...
                            MACHINE_NAME_ATTRIBUTE, MACHINE_QUEUE_NAME_ATTRIBUTE, 
